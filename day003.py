...
if direction.lower() == "left":
  ...
  lake = input("You come to a lake. Do you wait or swim? ")
  if lake.lower() == "swim":
    print ("You are eaten by a crocodile. Game over")
  else:
    door = input("You come to three doors. Red, Yellow, and Blue. Which do you open? ")
    if door.lower() == "red":
      print ("It's a room full of fire. Game over.")
    elif door.lower() == "blue":
      print ("It's a room full of water. Game over.")
    else:
      print ("It's a room full of gold. You win!")
